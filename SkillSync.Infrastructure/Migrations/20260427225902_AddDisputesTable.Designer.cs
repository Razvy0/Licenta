...
namespace SkillSync.Infrastructure.Migrations
{
    ...
    [Migration("20260427225902_AddDisputesTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkillSync.Core.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SkillSync.Core.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SkillSync.Core.Entities.Dispute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SkillSync.Core.Entities.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SkillSync.Core.Entities.Skill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SkillSync.Core.Entities.SwapRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SkillSync.Core.Entities.TimeTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SkillSync.Core.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SkillSync.Core.Entities.Dispute", b =>
                {
                    b.HasOne("SkillSync.Core.Entities.AppUser", "ReportedUser")
                        .WithMany("DisputesReceived")
                        .HasForeignKey("ReportedUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SkillSync.Core.Entities.AppUser", "Reporter")
                        .WithMany("DisputesReported")
                        .HasForeignKey("ReporterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SkillSync.Core.Entities.SwapRequest", "SwapRequest")
                        .WithMany("Disputes")
            ...
            modelBuilder.Entity("SkillSync.Core.Entities.Message", b =>
                {
                    b.HasOne("SkillSync.Core.Entities.AppUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SkillSync.Core.Entities.AppUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("SkillSync.Core.Entities.Review", b =>
                {
                    b.HasOne("SkillSync.Core.Entities.AppUser", "Reviewee")
                        .WithMany("ReviewsReceived")
                        .HasForeignKey("RevieweeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SkillSync.Core.Entities.AppUser", "Reviewer")
            ...
            modelBuilder.Entity("SkillSync.Core.Entities.Skill", b =>
                {
                    b.HasOne("SkillSync.Core.Entities.Category", "Category")
                        .WithMany("Skills")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SkillSync.Core.Entities.AppUser", "User")
                        .WithMany("Skills")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SkillSync.Core.Entities.SwapRequest", b =>
                {
                    b.HasOne("SkillSync.Core.Entities.Skill", "OfferedSkill")
                        .WithMany()
                    ...
                    b.HasOne("SkillSync.Core.Entities.Skill", "RequestedSkill")
                        .WithMany()
                        .HasForeignKey("RequestedSkillId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SkillSync.Core.Entities.AppUser", "Requester")
                        .WithMany()
